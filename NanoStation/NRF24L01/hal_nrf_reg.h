...
#define R_REGISTER		0x00  /* Register Read - can be omitted */
#define W_REGISTER     	0x20  /**< Register write command */
#define R_RX_PL_WID   	0x60  /**< Read RX payload width for top packet command */
#define R_RX_PAYLOAD    0x61  /**< Read RX payload command */
#define W_TX_PAYLOAD    0xA0  /**< Write TX payload command */
#define W_TX_PAYLOAD_NO_ACK 0xB0  /**< Write ACK payload command */
...
#define HAL_NRF_MAX_RT 	4
#define HAL_NRF_TX_DS 	5
#define HAL_NRF_RX_DR 	6
...
#endif
// Use real register address
#define HAL_NRF_PIPE0 (0x0a)
#define HAL_NRF_PIPE1 (0x0b)
#define HAL_NRF_PIPE2 (0x0c)
#define HAL_NRF_PIPE3 (0x0d)
#define HAL_NRF_PIPE4 (0x0e)
#define HAL_NRF_PIPE5 (0x0f)
#define HAL_NRF_TX (0x10)
...
#define HAL_NRF_AW_3BYTES (3)
#define HAL_NRF_AW_4BYTES (4)
#define HAL_NRF_AW_5BYTES (5)
